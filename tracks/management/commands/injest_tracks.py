...
class Command(BaseCommand):
    help = 'Create trackd from JSON file'

    def handle(self, *args, **kwargs):
        #  set the path to the datafile
        datafile = settings.BASE_DIR / 'core' /'data' / 'tracks.json'
        print("base", datafile, '\n')
        ...
        # convert list of dictionairies to list of track models, and bulk_create
